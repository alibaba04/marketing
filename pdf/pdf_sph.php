...
$pdf->image('../dist/img/setbola1.png',40,55,55,55);
$pdf->image('../dist/img/setbola2.png',120,55,55,55);
$pdf->Ln(55);
$pdf->Cell(0,6,'B.   KUBAH MODEL MADINAH',0,1,'L',0);
$pdf->image('../dist/img/madina1.png',40,120,55,55);
$pdf->image('../dist/img/madina2.png',120,120,55,55);
$pdf->Ln(60);
$pdf->Cell(0,6,'B.   KUBAH MODEL BAWANG',0,1,'L',0);
$pdf->image('../dist/img/bawang1.png',40,188,55,55);
$pdf->image('../dist/img/bawang2.png',120,188,55,55);
$pdf->Ln(63);
$pdf->Cell(0,6,'B.   KUBAH MODEL PINANG',0,1,'L',0);
$pdf->image('../dist/img/pinang1.png',40,255,55,55);
$pdf->image('../dist/img/pinang2.png',120,255,55,55);
$pdf->addpage();
$pdf->Ln(-6);
$pdf->Cell(68,6,'CONTOH MOTIF PLAFON',0,1,'C',0);
$pdf->SetFont('helvetica', '', 11);
$pdf->image('../dist/img/Plafon1.png',21,50,85,85);
$pdf->image('../dist/img/Plafon2.png',109,50,85,85);
$pdf->image('../dist/img/Plafon3.png',21,138,85,85);
$pdf->image('../dist/img/Plafon4.png',109,138,85,85);
$pdf->image('../dist/img/Plafon5.png',21,225,85,85);
$pdf->image('../dist/img/Plafon6.png',109,225,85,85);
$pdf->addpage();
$pdf->SetFont('helvetica', 'B', 11);
$pdf->Ln(-6);
$pdf->Cell(68,6,'CONTOH MOTIF PLAFON',0,1,'C',0);
$pdf->SetFont('helvetica', '', 11);
$pdf->image('../dist/img/Plafon7.png',21,50,85,85);
$pdf->image('../dist/img/Plafon8.png',109,50,85,85);
$pdf->image('../dist/img/Plafon9.png',21,138,85,85);
$pdf->image('../dist/img/Plafon10.png',109,138,85,85);
$pdf->image('../dist/img/Plafon11.png',21,225,85,85);
$pdf->image('../dist/img/Plafon12.png',109,225,85,85);
