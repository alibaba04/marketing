...
$pdf->Ln(3);
$pdf->MultiCell(171,5,'Dalam hal ini bertindak untuk dan atas nama Panitia Pembangunan '.$hasil['nmasjid'].', selanjutnya disebut',0,'J',0);
$pdf->Ln(-5);
$pdf->Cell(13.5,5,'',0,0,'',0);
