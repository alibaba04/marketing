...
case "sendnotif":
    ...
    $fields=array(
        ...
        "notification"=>array(
            "body"=>$_POST['message'],
            "title"=>'Sikubah',
            "click_action"=>"https://sikubah.com/marketingindex.php?page=view/".$_POST['nokk']
        )
    );
    $headers=array(
